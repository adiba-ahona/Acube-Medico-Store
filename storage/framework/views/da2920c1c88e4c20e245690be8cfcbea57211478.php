...
} elseif ($_instance->childHasBeenRendered('9xGl1I5')) {
    $componentId = $_instance->getRenderedChildComponentId('9xGl1I5');
    $componentTag = $_instance->getRenderedChildComponentTagName('9xGl1I5');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('9xGl1I5');
} else {
    $response = \Livewire\Livewire::mount('search-component');
    $html = $response->html();
    $_instance->logRenderedChild('9xGl1I5', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('Na9uwiX')) {
    $componentId = $_instance->getRenderedChildComponentId('Na9uwiX');
    $componentTag = $_instance->getRenderedChildComponentTagName('Na9uwiX');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Na9uwiX');
} else {
    $response = \Livewire\Livewire::mount('wishlist-count-component');
    $html = $response->html();
    $_instance->logRenderedChild('Na9uwiX', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
						<?php
...
} elseif ($_instance->childHasBeenRendered('p9Vqbjx')) {
    $componentId = $_instance->getRenderedChildComponentId('p9Vqbjx');
    $componentTag = $_instance->getRenderedChildComponentTagName('p9Vqbjx');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('p9Vqbjx');
} else {
    $response = \Livewire\Livewire::mount('cart-count-component');
    $html = $response->html();
    $_instance->logRenderedChild('p9Vqbjx', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
</html><?php /**PATH D:\11th Semester\CSE470\CSE470_AcubeMedicoStore\acube_medico_store\resources\views/layouts/guest.blade.php ENDPATH**/ ?>