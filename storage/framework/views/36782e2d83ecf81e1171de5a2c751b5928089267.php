                ...
                <div class="wrap-product-detail">
                    <div class="detail-media">
                        <div class="product-gallery">
                            ...
                            <li data-thumb="<?php echo e(asset('assets/images/medicines')); ?>/<?php echo e($product->image); ?>">
                                <img src="<?php echo e(asset('assets/images/medicines')); ?>/<?php echo e($product->image); ?>" alt="<?php echo e($product->name); ?>" />
                            </li>
                        </div>
                    </div>
                    <div class="detail-info">
                        ...
                        <div class="short-desc">
                            ...
                            <a href="#" class="btn add-to-cart" wire:click.prevent="addToMechanicPreferencelist(<?php echo e($product->id); ?>,'<?php echo e($product->name); ?>', <?php echo e($product->regular_price); ?>)">Add Preference List</a>
                            ...
                            <?php else: ?> 
                               <?php if($product->category_id == "3"): ?>
                                ...
                                <?php else: ?> 
                                     <a href="#" class="btn add-to-cart" wire:click.prevent="addToRequestedItemList (<?php echo e($product->id); ?>,'<?php echo e($product->name); ?>', <?php echo e($product->regular_price); ?>)">Request for Restock </a>
                                <?php endif; ?>
                            <?php endif; ?>
                            <div class =" wish-btn">
                        ...
                        <div class="tab-content-item " id="add_infomation">
                            <table class="shop_attributes">
                                <tbody>
                                    ...
                                    <tr>
                                        <th>Color</th><td><p>Black, Blue, Violet, Yellow</p></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                        ...
                        <li class="service">
                            <a class="link-to-service" href="/shop">
                                ...
                                <div class="right-content">
                                    ...
                                    <span class="subtitle">On Order Over 50tk</span>
...
</main><?php /**PATH D:\11th Semester\CSE470\CSE470_AcubeMedicoStore\acube_medico_store\resources\views/livewire/details-component.blade.php ENDPATH**/ ?>