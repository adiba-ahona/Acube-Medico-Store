                ...
                <div class="wrap-product-detail">
                    <div class="detail-media">
                        <div class="product-gallery">
                            ...
                            <li data-thumb="{{asset('assets/images/medicines')}}/{{$product->image}}">
                                <img src="{{asset('assets/images/medicines')}}/{{$product->image}}" alt="{{$product->name}}" />
                            </li>
                        </div>
                    </div>
                        ...
                        <div class="short-desc">
                            ...
                            @else 
                               @if ($product->category_id == "3")
                                ...
                                @else 
                                     <a href="#" class="btn add-to-cart" wire:click.prevent="addToRequestedItemList ({{$product->id}},'{{$product->name}}', {{$product->regular_price}})">Request for Restock </a>
                                @endif
                            @endif
                            <div class =" wish-btn">
