	...
	<div class="wrap-search-form">
		<form action="{{route('product.mainsearch')}}" id="form-search-top" name="form-search-top">
		    ...
		    <div class="wrap-list-cate">
				<input type="hidden" name="product_catagory" value="{{$product_category}}" id="product-cate">
                <input type="hidden" name="product_catagory_id" value="{{$product_category_id}}" id="product-cate-id">
